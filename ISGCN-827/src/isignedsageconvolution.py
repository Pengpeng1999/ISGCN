...
class SignedSAGEConvolutionBase(SignedSAGEConvolution): # 这个是在有向上操作的
    """
...
class SignedSAGEConvolution_tm_1(SignedSAGEConvolution):
    """
    tm+1-layer.
    """
    def forward(self, x_1, x_2, edge_index_pos, edge_index_neg):
        ...
        edge_index_pos, _ = add_self_loops(edge_index_pos, num_nodes=x_1.size(0))  # 每一个节点加自环
